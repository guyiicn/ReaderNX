...
LIBS	:=	-lSDL2 -lSDL2_ttf -lSDL2_image -lwebp -lEGL -lglapi -ldrm_nouveau `sdl2-config --libs` -larchive -lzstd -llzma -lz -lstdc++ -lnx -lmupdf -Wl,--allow-multiple-definition -lharfbuzz -lmupdf-third -lfreetype -lm -ljpeg -lpng -lbz2
